...
public class EvidencijaTableModel extends AbstractTableModel{
    ...
    private final String[] kolone = new String[]{"<html>&nbsp;<br>Taksista<br>&nbsp;", "<html>Datum <br>vo\u017Enje","<html>Po\u010Detna <br>kilometra\u017Ea","<html>Kilometra\u017Ea <br>na kraju","Zarada","Uneo"};
    private final DateFormat dz = new SimpleDateFormat("dd.MM.yyyy.");
    
    public EvidencijaTableModel() {
    }

    public EvidencijaTableModel(List<EvidencijaVoznje> listaEvidencija) {
